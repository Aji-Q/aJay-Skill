...
测试覆盖：
1. evaluator.get_locked_school 正确解析 AJAY_SCHOOL env
...
def test_run_py_has_school_argument():
    ...
    # 应设置 AJAY_SCHOOL env · 让 evaluator 读取
    assert 'AJAY_SCHOOL' in run_py
