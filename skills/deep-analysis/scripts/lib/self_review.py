...
def check_coverage_threshold(ctx: dict) -> list[Issue]:
    ...
    if pct < 60:
        ...
        import os as _os
        is_cli_only = (
            _os.environ.get("AJAY_DEPTH") == "lite"
            or _os.environ.get("AJAY_LITE") == "1"
            or _os.environ.get("AJAY_CLI_ONLY") == "1"
...
def check_agent_analysis_exists(ctx: dict) -> list[Issue]:
    ...
    import os
    is_cli_only = (
        os.environ.get("AJAY_DEPTH") == "lite"
        or os.environ.get("AJAY_LITE") == "1"
        or os.environ.get("AJAY_CLI_ONLY") == "1"
