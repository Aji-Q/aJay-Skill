...
<div class="container" style="max-width:1180px;margin:0 auto;padding:30px 24px">
  <div class="topbar">
    <div class="left">
      ...
      <div class="brand">J Trader <span>PORTFOLIO</span></div>
    </div>
    <div class="status">
  ...
  <div style="text-align:center;padding:30px 0 16px;color:var(--text-dim);font-size:11px;letter-spacing:.1em">
    Generated by J Trader · Maintained by aJay · J Trader v1.2.0 · 组合分析模式
  </div>
</div>

<script>
(function() {{
  const KEY = 'ajay-theme';
...
def run_portfolio(
    ...
    *,
    ...
    if depth:
        os.environ.setdefault("AJAY_DEPTH", depth)
    ...
    if auto_open and not os.environ.get("AJAY_NO_AUTO_OPEN"):
        try:
            import webbrowser
