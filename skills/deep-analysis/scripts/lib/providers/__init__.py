...
## 环境变量
  ...
  AJAY_PROVIDERS_<DIM>  · 单维度覆盖偏好，如 AJAY_PROVIDERS_FINANCIALS=tushare,akshare
"""
...
def try_chain(
    ...
    **kwargs,
    ...
    Args:
      ...
      dim:    维度关键字，用于读 AJAY_PROVIDERS_<DIM> env 覆盖顺序
      market: "A" / "H" / "U"
