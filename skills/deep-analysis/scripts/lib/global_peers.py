...
def to_yahoo_symbol(ticker_info) -> str:
    """Map aJay canonical symbols to Yahoo's exchange suffix conventions."""
...
class YahooGlobalPeerProvider:
    ...
    def financials(self, symbol: str, years: int = 6) -> dict:
        ...
        response = self.session.get(
            ...
            headers={"User-Agent": "aJay-Skill/3 global-peer-comparison"},
...
def fetch_global_peer_comparison(
    ...
    def collect():
        ...
        if basic:
            ...
            target["ajay_symbol"] = ticker_info.full
